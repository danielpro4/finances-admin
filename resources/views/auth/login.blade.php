    ...
    <div class="account-body">
        ...
        <form class="form account-form" method="POST" action="./index.html">
            ...
            <div class="form-group">
                <label for="login-username" class="placeholder-hidden">Usuário</label>
                <input type="text" class="form-control" id="login-username" placeholder="Usuário" tabindex="1">
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" id="login-password" placeholder="Senha" tabindex="2">
            </div>
            <!-- /.form-group -->
