...
@section('content')
    ...
    <div class="portlet">
        ...
        <div class="portlet-content">
            ...
            <form id="validate-basic" method="post" action="{{ route('spent.update', $spent->id) }}"
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        ...
                        <input type="text" id="description" name="description" class="form-control"
                               data-required="true" value="{{$spent->description}}">
                    </div>
                </div>
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="input-group date ui-datepicker" data-date-format="dd/mm/yyyy">
                            <input id="dueDate" name="dueDate" class="form-control" type="text" data-required="true"
                                   value="{{$spent->dueDate->format('d/m/Y')}}">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="input-group date ui-datepicker" data-date-format="dd/mm/yyyy">
                            <input id="paymentDate" name="paymentDate" class="form-control" type="text"
                                   value="{{$spent->paymentDate->format('d/m/Y')}}">
                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                        </div>
                    </div>
                </div>
